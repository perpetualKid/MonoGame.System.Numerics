...
namespace MonoGame.Tests.Framework
{
    class Vector2Test
    {
        ...
        public void Hermite()
        {
            ...
            result1 = Vector2Extension.Hermite(v1, v2, v3, v4, 0.25f);
            result2 = Vector2Extension.Hermite(v5, v6, v7, v8, 0.45f);
        ...
        public void Transform()
        {
            ...
            result1 = Vector2.Transform(v1, m1);
            result2 = Vector2.Transform(v2, q2);
            ...
            // TRANSFORM ON LIST (MATRIX)
            {
                ...
                Vector2Extension.Transform(sourceList1, 0, ref m1, desinationList1, 0, 10);
            ...
            // TRANSFORM ON LIST (MATRIX)(DESTINATION & SOURCE)
            {
                ...
                Vector2Extension.Transform(sourceList2, 2, ref m1, desinationList2, 1, 3);
            ...
            // TRANSFORM ON LIST (MATRIX)(SIMPLE)
            {
                ...
                Vector2Extension.Transform(sourceList3, ref m1, desinationList3);
            ...
            // TRANSFORM ON LIST (QUATERNION)
            {
                ...
                Vector2Extension.Transform(sourceList4, 0, ref q3, desinationList4, 0, 10);
            ...
            // TRANSFORM ON LIST (QUATERNION)(DESTINATION & SOURCE)
            {
                ...
                Vector2Extension.Transform(sourceList5, 2, ref q3, desinationList5, 1, 3);
            ...
            // TRANSFORM ON LIST (QUATERNION)(SIMPLE)
            {
                ...
                Vector2Extension.Transform(sourceList6, ref q3, desinationList6);
        ...
        public void TransformNormal()
        {
            ...
            Vector2 result;
            Vector2Extension.TransformNormal(ref normal, ref matrix, out result);
            ...
            // TRANSFORM ON LIST
            {
                ...
                Vector2Extension.TransformNormal(sourceArray1, 0, ref matrix, destinationArray1, 0, 10);
            ...
            // TRANSFORM ON LIST(SOURCE OFFSET)
            {
                ...
                Vector2Extension.TransformNormal(sourceArray2, 5, ref matrix, destinationArray2, 0, 5);
            ...
            // TRANSFORM ON LIST(DESTINATION OFFSET)
            {
                ...
                Vector2Extension.TransformNormal(sourceArray3, 0, ref matrix, destinationArray3, 5, 5);
            ...
            // TRANSFORM ON LIST(DESTINATION & SOURCE)
            {
                ...
                Vector2Extension.TransformNormal(sourceArray4, 2, ref matrix, destinationArray4, 3, 6);
            ...
            // TRANSFORM ON LIST(SIMPLE)
            {
                ...
                Vector2Extension.TransformNormal(sourceArray5, ref matrix, destinationArray5);
