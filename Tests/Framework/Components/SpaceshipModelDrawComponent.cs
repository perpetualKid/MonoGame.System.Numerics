...
namespace MonoGame.Tests.Components
{
	class SpaceshipModelDrawComponent : VisualTestDrawableGameComponent
	{
		...
		protected override void UpdateOncePerDraw(GameTime gameTime)
		{
			...
			spaceship.Rotation = Matrix4x4.CreateWorld(new System.Numerics.Vector3(0, 250, 0), new System.Numerics.Vector3(0, 0, -1), new System.Numerics.Vector3(0, 1, 0)) *
			...
			spaceship.View = Matrix4x4.CreateLookAt (
				new System.Numerics.Vector3(3500, 400, 0) + new System.Numerics.Vector3(0, 250, 0),
				new System.Numerics.Vector3(0, 250, 0),
