...
namespace MonoGame.Tests.Components {
	class Simple3DCubeComponent
	{
		...
		public void LoadContent ()
		{
			...
			viewMatrix = Matrix4x4.CreateLookAt (new System.Numerics.Vector3 (0, 0, 5), System.Numerics.Vector3.Zero, new System.Numerics.Vector3(0, 1, 0));
		...
		public void Draw()
		{
			...
			basicEffect.World = worldMatrix * Matrix4x4.CreateTranslation(new System.Numerics.Vector3(CubePosition.X, CubePosition.Y, CubePosition.Z));
