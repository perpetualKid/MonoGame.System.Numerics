...
namespace Microsoft.Xna.Framework.Graphics
{
    ...
    internal static class EffectHelpers
    {
        ...
        internal static EffectDirtyFlags SetWorldViewProjAndFog(EffectDirtyFlags dirtyFlags,
                                                                in Matrix4x4 world, in Matrix4x4 view, in Matrix4x4 projection, ref Matrix4x4 worldView,
                                                                ...
                                                                EffectParameter worldViewProjParam, EffectParameter fogVectorParam)
        {
            ...
            if (fogEnabled)
            {
                ...
                {
                    SetFogVector(in worldView, fogStart, fogEnd, fogVectorParam);
        ...
        /// </summary>
        static void SetFogVector(in Matrix4x4 worldView, float fogStart, float fogEnd, EffectParameter fogVectorParam)
        {
            if (fogStart == fogEnd)
            {
        ...
        /// </summary>
        internal static EffectDirtyFlags SetLightingMatrices(EffectDirtyFlags dirtyFlags, in Matrix4x4 world, in Matrix4x4 view,
